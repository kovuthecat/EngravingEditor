...
- [ ] T-135 — Section Projet épinglée (sticky) en bas de sidebar · modèle: Sonnet, effort: medium (low) · plan: `plans/P9/` (S10, dépend S9)
- [ ] T-136 — PWA : manifest + plein écran iPad + safe-area · modèle: Sonnet, effort: medium · plan: `plans/P9/` (S10)
- [ ] T-137 — Étendre `test/pencil-probe.html` (twist/altitude/azimuth/tangential) · modèle: Haiku, effort: low · plan: `plans/P9/` (S3)
- [ ] T-138 — [Humain] Valider capacités Pencil Pro sur iPad (gate go/no-go Lot E) · modèle: — (humain) · plan: `plans/P9/` (S11, dépend T-137)
- [ ] T-139 — `twist` → angle de plume + hover atténué (si go) · modèle: Sonnet, effort: high · plan: `plans/P9/` (S11, dépend T-138)
- [ ] T-140 — Mode « ombrage » par inclinaison Pencil (variableStroke, si go) · modèle: Sonnet, effort: high · plan: `plans/P9/` (S12, dépend T-138)
